...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Daftar Member')); ?></div>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telepon" type="number" class="form-control<?php echo e($errors->has('telepon') ? ' is-invalid' : ''); ?>" name="telepon" value="<?php echo e(old('telepon')); ?>" required autofocus>
